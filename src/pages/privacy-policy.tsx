...
import { Container, Flex, Grid, Paragraph } from "theme-ui";
  ...
  return (
    <Layout>
      <Grid sx={{ width: "100%", px: "2em" }}>
        ...
        <Flex sx={{ flexDirection: "column", pt: "1em", gap: "1em" }}>
          <Paragraph variant="smallheader">1. Innledning</Paragraph>
          ...
          <Paragraph variant="smallheader">Nettside </Paragraph>
          <Paragraph variant="standard">
          ...
          <Paragraph variant="smallheader">Chat og e-post </Paragraph>
          <Paragraph variant="standard">
          ...
          <Paragraph variant="smallheader">Google </Paragraph>
          <Paragraph variant="standard">
          ...
          <Paragraph variant="smallheader">Freshdesk </Paragraph>
          <Paragraph variant="standard">
          ...
          <Paragraph variant="smallheader">4. Dine rettigheter</Paragraph>
          <Paragraph variant="standard">
          ...
          <Paragraph variant="smallheader">6. Kontaktinformasjon</Paragraph>
          <Paragraph variant="standard">
